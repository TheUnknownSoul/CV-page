            ...
            <div className="mt-6 border-t border-gray-100">
                <dl className="divide-y divide-gray-100">
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd className="mt-1 text-lg leading-6 text-black sm:col-span-2 sm:mt-0 font-semibold text-transform">Roi
                            Andrii
                        </dd>
                    </div>
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        <dt className="text-base font-medium leading-6 text-white-900">Job title</dt>
                        <dd className="mt-1 text-lg leading-6 text-black sm:col-span-2 sm:mt-0">Full Stack Software
                    ...
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd className="mt-1 text-lg leading-6 text-black sm:col-span-2 sm:mt-0">andriyroy3@gmail.com</dd>
                    </div>
                    ...
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd className="mt-1 text-base leading-6 text-black sm:col-span-2 sm:mt-0">
                            ...
                            <ul className="divide-y divide-gray-100 rounded-md border border-gray-200 list-disc justify-between py-4 pl-4 pr-8 text-base leading-6 text-black">
                        ...
                        <dd className="mt-1 text-base leading-6 text-black sm:col-span-2 sm:mt-0"><h3
                    ...
                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd className="mt-1 text-base leading-6 text-black sm:col-span-2 sm:mt-0">
                            ...
                            <h2 className="text-balance font-semibold leading-8 text-white-900">03.2022 -
                                present</h2>
                            <ul className=" list-disc justify-between py-4 pl-4 pr-8 text-base leading-6 text-black">
                                ...
                                <li>Key technologies: Java 17, React, Python, C++, Javascript, Spring Boot, Spring Security, Docker</li>
                            </ul>
                            <h2 className="text-base text-decoration-line: underline; font-semibold leading-8 text-white-900">
                                GoIT
                            </h2>
